...
import { PoleAnalysisTypeSelectionComponent } from './components/pole-analysis-type-selection/pole-analysis-type-selection.component';
import { LineAnalysisTypeSelectionComponent } from './components/line-analysis-type-selection/line-analysis-type-selection.component';
...
export const routes: Routes = [
    ...
    {
        path: 'line/:routeLine/:direction', component: LineAnalysisTypeSelectionComponent
    },
    {
    ...
    {
        path: 'stop/:routeStopId/:routeStopName/:routePoleName', component: PoleAnalysisTypeSelectionComponent,
    },
    {
