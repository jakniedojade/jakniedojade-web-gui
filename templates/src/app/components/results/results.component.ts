...
export class ResultsComponent implements OnInit {
  ...
  private prepareAndDraw(shapes: Shapes[], poles: PoleDetails[]): void {
  ...
  private mapPoleCoordinatesToShapes(shapes: Shapes[], polesToMap: PoleDetails[]): PoleDetails[] {
  ...
  private sliceShapes(shapes: Shapes[], mappedPoles: PoleDetails[]): Shapes[] {
  ...
  navigateToLine(): void {
    this.router.navigate([`line/${this.line}`])
  }
}
